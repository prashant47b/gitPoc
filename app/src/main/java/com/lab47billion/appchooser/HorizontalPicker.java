 ...
 */
public class HorizontalPicker extends RelativeLayout {
    ...
    private float mNormalTextSize = -1;
    ...
    private boolean isScrollingStart = false;
...
//                }
    ...
    public void setValues(CharSequence[] values) {
        ...
        if (mValues != values) {
            ...
            if (mValues != null) {
                mLayouts = new View[mValues.length][2];
                for (int i = 0; i < mLayouts.length; i++) {
...
//                    if(subText != null) {
//                        mLayouts[i][1] = new BoringLayout(subText, mTextPaint, mItemWidth, Layout.Alignment.ALIGN_CENTER,
//                                1f, 1f, mBoringMetrics, false, mEllipsize, mItemWidth);
//                    }
                }
            } else {
                mLayouts = new View[0][0];
            }
