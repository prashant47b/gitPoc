package com.lab47billion.appchooser.week;
...
import static com.lab47billion.appchooser.week.WeekViewUtil.isSameDay;
import static com.lab47billion.appchooser.week.WeekViewUtil.isSameDayAndHour;
import static com.lab47billion.appchooser.week.WeekViewUtil.today;
...
public class WeekView extends View {
     ...
     * @see #setMinDate(java.util.Calendar)
     * @see #setMaxDate(java.util.Calendar)
...
//                        WeekViewEvent newEvent = new WeekViewEvent(mNewEventId, mNewEventText, null, selectedTime, endTime);
    ...
    public WeekView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mNewEventColor = a.getColor(com.alamkanak.weekview.R.styleable.WeekView_newEventColor, mNewEventColor);
            ...
            mNewEventIconDrawable = a.getDrawable(com.alamkanak.weekview.R.styleable.WeekView_newEventIconResource);
            mNewEventId = a.getInt(com.alamkanak.weekview.R.styleable.WeekView_newEventId, mNewEventId);
            mNewEventLengthInMinutes = a.getInt(com.alamkanak.weekview.R.styleable.WeekView_newEventLengthInMinutes, mNewEventLengthInMinutes);
            mNewEventTimeResolutionInMinutes = a.getInt(com.alamkanak.weekview.R.styleable.WeekView_newEventTimeResolutionInMinutes, mNewEventTimeResolutionInMinutes);
            ...
            mAllDayEventHeight = a.getInt(com.alamkanak.weekview.R.styleable.WeekView_allDayEventHeight, mAllDayEventHeight);
        } finally {
            a.recycle();
        }
    ...
    private void init() {
        ...
        mHeaderTextHeight = 2 * rect.height();
...
//                int difference = (today.get(Calendar.DAY_OF_WEEK) - mFirstDayOfWeek);
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            boolean isToday = WeekViewUtil.isSameDay(day, today);
...
//            boolean sameDay = isSameDay(day, today);
            ...
            if (dayLabel == null) {
                ...
                canvas.drawText(dayLabel.split("-")[0], startPixel + mWidthPerDay / 2, mHeaderTextHeight, isToday ? mTodayHeaderTextPaint : mHeaderTextPaint);
                canvas.drawText(dayLabel.split("-")[1], startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding, isToday ? mTodayHeaderTextPaint : mHeaderTextPaint);
            }
     ...
     * </p>
     * @param length Supported values are {@link com.lab47billion.appchooser.week.WeekView#LENGTH_SHORT} and
     * {@link com.lab47billion.appchooser.week.WeekView#LENGTH_LONG}.
     */
    @Deprecated
...
//        mCurrentOrigin.x = - dateDifference * (mWidthPerDay + mColumnGap);
    ...
    public interface EventLongPressListener {
        /**
         * Similar to {@link com.lab47billion.appchooser.week.WeekView.EventClickListener} but with a long press.
         * @param event: event clicked.
         * @param eventRect: view containing the clicked event.
         */
    ...
    public interface EmptyViewClickListener {
         ...
         * @param time: {@link java.util.Calendar} object set with the date and time of the clicked position on the view.
         */
    ...
    public interface EmptyViewLongPressListener {
        /**
         * Similar to {@link com.lab47billion.appchooser.week.WeekView.EmptyViewClickListener} but with long press.
         * @param time: {@link java.util.Calendar} object set with the date and time of the long pressed position on the view.
         */
